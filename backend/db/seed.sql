...
-- Users
INSERT INTO flow_users (id, username, name, email, phone, avatar_url, is_verified, location, rating, reviews_count, listings_count, sales_count, bio, member_duration, positive_percent, role, created_at) VALUES
('user_001', 'carlos',     'Carlos Mendoza', 'carlos@example.com', '+52 55 1234 5678', '', TRUE,  'Ciudad de Mexico, Mexico', 4.9, 3, 12, 48, '', '', 0.00, 'seller', NOW() - INTERVAL 2 YEAR),
('user_002', 'maria',      'Maria Lopez',    'maria@example.com',    '+52 33 1111 2222', '', TRUE,  'Guadalajara, Mexico',      4.8, 3, 24, 95,  'Vendedor profesional de electrónicos. Envío a todo el país.', '2 years', 98.50, 'seller', NOW() - INTERVAL 2 YEAR),
('user_003', 'juan',       'Juan Perez',     'juan@example.com',     '+52 81 3333 4444', '', FALSE, 'Monterrey, Mexico',        4.2, 1, 15, 32,  'Ropa y calzado deportivo de marca.',                          '1 year',  92.00, 'seller', NOW() - INTERVAL 1 YEAR),
('user_004', 'ana',        'Ana Garcia',     'ana@example.com',      '+52 22 5555 6666', '', TRUE,  'Puebla, Mexico',           4.9, 2, 32, 128, 'Apple products specialist. Certified reseller.',               '3 years', 99.20, 'seller', NOW() - INTERVAL 3 YEAR),
('user_005', 'pedro',      'Pedro Sanchez',  'pedro@example.com',    '+52 44 7777 8888', '', FALSE, 'Puebla, Mexico',           4.5, 0, 8,  21,  'Muebles y hogar.',                                             '8 months', 95.00, 'seller', NOW() - INTERVAL 8 MONTH),
('user_006', 'laura',      'Laura Torres',   'laura@example.com',    '+52 44 9999 0000', '', FALSE, 'Queretaro, Mexico',        4.6, 0, 5,  15,  'Deportes y aire libre.',                                       '1 year',  94.00, 'seller', NOW() - INTERVAL 1 YEAR);
...
-- Categories
INSERT INTO flow_categories (id, name, icon, count) VALUES
...
-- Listings
INSERT INTO flow_listings (id, seller_id, title, description, price, currency, images, category, subcategory, status, created_at, is_featured, view_count, favorite_count, item_condition, location) VALUES
...
INSERT INTO flow_favorites (user_id, listing_id) VALUES
('user_001', 'list_001'),
('user_001', 'list_003');

-- Orders
INSERT INTO flow_orders (id, buyer_id, seller_id, listing_id, listing_title, listing_image, price, currency, status, created_at, shipping_address, payment_method, is_paid, quantity) VALUES
...
-- Reviews
INSERT INTO flow_reviews (id, seller_id, reviewer_id, user_name, user_avatar, rating, date, text, has_photo, photo_url) VALUES
...
INSERT INTO flow_notifications (id, user_id, title, body, type, is_read, created_at, data) VALUES
